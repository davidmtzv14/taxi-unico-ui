...
@NgModule({
  declarations: [AdminComponentComponent, AdminContainerComponent, ClientTabComponent, TaxiTabComponent, ServiceDetailsTabComponent, ClientTabContainerComponent, TaxiTabContainerComponent, ServiceDetailsTabContainerComponent, DetailsTabContainerComponent, DetailsTabComponent],
  imports: [
